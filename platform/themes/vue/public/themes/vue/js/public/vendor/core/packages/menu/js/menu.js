...
"use strict";
/*!*****************************************************!*\
  !*** ./platform/packages/menu/resources/js/menu.js ***!
  \*****************************************************/
  ...
  return _createClass(MenuNestable, [{
    ...
    value: function handleNestableMenu() {
      ...
      $(document).on('click', '.box-links-for-menu .btn-add-to-menu', function (e) {
        e.preventDefault();
        var current = $(e.currentTarget);
        var parent = current.closest('.box-links-for-menu').find('.the-box');
        var position = $('#nestable .dd-list .dd-item').length + 1;
        if (parent.attr('id') === 'external_link') {
          ...
          parent.find('.list-item li.active').each(function (index, el) {
            var findIn = $(el).find('> label > input[type=checkbox]');
            var params = {};
            params.reference_type = sanitize_html__WEBPACK_IMPORTED_MODULE_0___default()(findIn.data('reference-type'));
            params.reference_id = sanitize_html__WEBPACK_IMPORTED_MODULE_0___default()(findIn.data('reference-id'));
            params.title = sanitize_html__WEBPACK_IMPORTED_MODULE_0___default()(findIn.data('title'));
            params.menu_id = sanitize_html__WEBPACK_IMPORTED_MODULE_0___default()(findIn.data('menu-id'));
            params.reference_type = sanitize_html__WEBPACK_IMPORTED_MODULE_0___default()(findIn.data('reference-type'));
            params.reference_id = sanitize_html__WEBPACK_IMPORTED_MODULE_0___default()(findIn.data('reference-id'));
            params.title = sanitize_html__WEBPACK_IMPORTED_MODULE_0___default()(findIn.data('title'));
            params.menu_id = sanitize_html__WEBPACK_IMPORTED_MODULE_0___default()(findIn.data('menu-id'));
      ...
      var createMenuNode = function createMenuNode(params, current, parent, url) {
