...
/*!**************************************************************************!*\
  !*** ./platform/plugins/custom-field/resources/js/import-field-group.js ***!
  \**************************************************************************/
...
(function ($) {
  var $body = $('body');
  $body.on('click', 'button.custom-import-button', function (event) {
    event.preventDefault();
    event.stopPropagation();
    var $form = $(document).find('form.import-field-group');
  ...
  $body.on('change', 'form.import-field-group input[type=file]', function (event) {
    ...
    if (file) {
      ...
      reader.onload = function (e) {
        ...
        Botble.blockUI();
        $httpClient.make().post($form.attr('action'), {
          json_data: json
        }).then(function (_ref) {
          var data = _ref.data;
